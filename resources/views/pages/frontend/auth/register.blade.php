        ...
        <div class="flex flex-col items-center justify-center w-full h-full lg:px-16 lg:w-1/2 md:w-1/2 form-container lg:items-start md:items-starty">
            ...
            <form class="w-full max-w-sm" method="POST" action="{{ route('register.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" placeholder="Enter your name" class="w-full px-3 py-2.5 leading-tight text-gray-700 border rounded-lg shadow appearance-none focus:outline-none focus:shadow-outline border-primary">
                </div>
                <div class="mb-4">
                    <label for="email" class="block mb-2 text-sm font-bold text-gray-700">Email</label>
                    <input type="email" id="email" name="email" placeholder="Enter your email" class="w-full px-3 py-2.5 leading-tight text-gray-700 border rounded-lg shadow appearance-none focus:outline-none focus:shadow-outline border-primary">
                </div>
                <div class="mb-6">
                    <label for="password" class="block mb-2 text-sm font-bold text-gray-700">Password</label>
                    <input type="password" id="password" name="password" placeholder="Create a strong password" class="w-full px-3 py-2.5 leading-tight text-gray-700 border rounded-lg shadow appearance-none focus:outline-none focus:shadow-outline border-primary">
                </div>
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm font-bold text-gray-600">Already have an account? <a href="{{ route('user.login') }}" class="text-secondary hover:text-primary">Log In</a></p>
                </div>
            </form>
