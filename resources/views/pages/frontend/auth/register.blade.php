            ...
            <form class="w-full max-w-sm">
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" placeholder="john doe"
                        class="w-full px-3 py-2.5 leading-tight text-gray-700 border rounded-lg shadow appearance-none focus:outline-none focus:shadow-outline border-primary">
                </div>
                <div class="mb-4">
                    <label for="email" class="block mb-2 text-sm font-bold text-gray-700">Email</label>
                    <input type="email" id="email" name="email" placeholder="johndoe123@gmail.com"
                        class="w-full px-3 py-2.5 leading-tight text-gray-700 border rounded-lg shadow appearance-none focus:outline-none focus:shadow-outline border-primary">
                </div>
                <div class="mb-6">
                    <label for="password" class="block mb-2 text-sm font-bold text-gray-700">Password</label>
                    <input type="password" id="password" name="password" placeholder="example : Budiono123?"
                        class="w-full px-3 py-2.5 leading-tight text-gray-700 border rounded-lg shadow appearance-none focus:outline-none focus:shadow-outline border-primary">
                </div>
                <div class="flex items-center justify-between">
                    <button type="submit"
                            class="w-full px-4 py-2.5 font-bold text-white rounded-lg bg-gradient-to-r from-primary to-secondary hover:bg-gradient-to-br focus:outline-none focus:shadow-outline ">
                        Sign Up
                    </button>
                </div>
