...
<section class="flex items-center justify-center w-full min-h-screen bg-lightBlue">
    <div class="container flex flex-col items-center justify-center w-full h-full gap-6 mt-32 lg:flex-row lg:items-center lg:justify-center lg:gap-36 lg:mt-20">
        <div class="p-4 text-center lg:text-left motion-opacity-in-0 motion-translate-y-in-100 motion-blur-in-md md:p-0 lg:p-0">
            ...
            <button class="px-8 py-3 mt-5 font-bold text-white bg-gradient-to-r from-primary to-secondary rounded-4xl hover:bg-primary cursor-pointer hover:from-secondary hover:to-primary">
                <i class="fa fa-arrow-right mr-0.5"></i> Ayo Mulai
            </button>
        </div>
    ...
    <div class="container flex flex-col items-center justify-center w-full gap-4 px-4 lg:flex-row lg:items-center lg:justify-center lg:gap-32 ">
        <div class="w-full col flex-col lg:w-1/3 bg-white shadow-xl min-h-[300px] lg:min-h-[400px] flex rounded-2xl mx-4 lg:mx-0 transition-all duration-700 opacity-100 translate-y-0 p-8 gap-4">
            ...
            <div class="flex items-end w-full px-4 py-2 border border-gray-300 rounded-lg">
                <input type="text" placeholder="Tanya Apa Saja Mengenai Ternak Ikan" class="w-full text-gray-600 placeholder-gray-400 bg-transparent outline-none">
...
<section class="flex flex-col items-center justify-start w-full py-8 pb-48 bg-gradient-to-t from-white to-lightBlue ">
    <div class="max-w-screen-xl px-4 py-12 mx-auto text-center sm:px-6 lg:px-8 lg:py-16">
        ...
        <div class="grid grid-cols-1 gap-4 mt-8 md:grid-cols-3 md:gap-8 lg:mt-24">
            <blockquote class="motion-opacity-in-0 motion-translate-y-in-100 motion-blur-in-md relative p-6 sm:p-8 transition-all ease-in-out duration-300 transform bg-white border border-gray-200 shadow-md rounded-2xl hover:shadow-lg hover:-translate-y-1">
                <!-- Kutipan Icon -->
                <div class="absolute -top-4 left-4 bg-primary text-white p-3 rounded-full shadow-md">
                ...
                <div class="flex items-center gap-4">
                    <!-- Foto Profil -->
                    <img alt="Foto Mas Budi" src="{{ asset('assets/images/foto1.jpeg') }}" class="object-cover rounded-full w-16 h-16 border-2 border-primary shadow-md ring-2 ring-offset-2 ring-gray-200 transition-transform duration-300 hover:scale-105" />
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-lg font-semibold text-gray-900 text-start">Mas Budi</p>
                    </div>
                </div>

                <!-- Isi Testimoni -->
                <p class="mt-4 text-gray-700 leading-relaxed">
                    Saya baru memulai usaha peternakan ikan di kolam kecil, dan aplikasi
                    <span class="font-semibold text-primary">Marivora</span> benar-benar membantu saya.
                    Fitur panduan pemula sangat mudah diikuti, dari cara membuat kolam hingga pemilihan bibit ikan yang tepat.
                    Sekarang saya merasa lebih percaya diri untuk mengembangkan usaha ini.
                    <span class="font-semibold text-primary">Terima kasih, Marivora!</span>
                </p>

                <!-- Garis Dekoratif -->
                <div class="mt-4 w-16 h-1 bg-primary rounded-full"></div>
            </blockquote>
            <blockquote class="motion-opacity-in-0 motion-translate-y-in-100 motion-blur-in-md relative p-6 sm:p-8 transition-all ease-in-out duration-300 transform bg-white border border-gray-200 shadow-md rounded-2xl hover:shadow-lg hover:-translate-y-1">
                <!-- Kutipan Icon -->
                <div class="absolute -top-4 left-4 bg-primary text-white p-3 rounded-full shadow-md">
                ...
                <div class="flex items-center gap-4">
                    <!-- Foto Profil -->
                    <img alt="Foto Mas Budi" src="{{ asset('assets/images/foto2.jpeg') }}" class="object-cover rounded-full w-16 h-16 border-2 border-primary shadow-md ring-2 ring-offset-2 ring-gray-200 transition-transform duration-300 hover:scale-105" />
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-lg font-semibold text-gray-900 text-start">Ardi Marjan</p>
                    </div>
                </div>

                <!-- Isi Testimoni -->
                <p class="mt-4 text-gray-700 leading-relaxed">
                    Aplikasi <span class="font-semibold text-primary">Marivora</span> sangat membantu dalam manajemen kolam ikan saya. Fitur monitoring kualitas air dan pemberian pakan otomatis sangat praktis. Hanya saja, saya berharap ada lebih banyak analitik untuk memantau perkembangan hasil panen secara detail. <span class="font-semibold text-primary">Secara keseluruhan, aplikasi ini sangat berguna!</span>
                </p>
            ...
            <blockquote class="motion-opacity-in-0 motion-translate-y-in-100 motion-blur-in-md relative p-6 sm:p-8 transition-all ease-in-out duration-300 transform bg-white border border-gray-200 shadow-md rounded-2xl hover:shadow-lg hover:-translate-y-1">
                ...
                <div class="flex items-center gap-4">
                    <!-- Foto Profil -->
                    <img alt="Foto Mas Budi" src="{{ asset('assets/images/rasya.png') }}" class="object-cover rounded-full w-16 h-16 border-2 border-primary shadow-md ring-2 ring-offset-2 ring-gray-200 transition-transform duration-300 hover:scale-105" />
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-lg font-semibold text-gray-900 text-start">Mas Asep</p>
                    </div>
                </div>

                <!-- Isi Testimoni -->
                <p class="mt-4 text-gray-700 leading-relaxed">
                    Saya sudah mengelola kolam ikan selama bertahun-tahun, tetapi aplikasi <span class="font-semibold text-primary">Marivora</span> memberikan solusi baru yang sangat efektif. Fitur untuk menghitung biaya operasional dan estimasi keuntungan <span class="font-semibold text-primary">sangat membantu</span> dalam merencanakan bisnis saya. Aplikasi ini membuat semuanya lebih terorganisir dan efisien.
                </p>
