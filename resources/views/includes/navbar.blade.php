...
<nav class="fixed top-0 z-20 w-full bg-white border-b border-white dark:bg-white start-0 dark:border-white">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto" onclick="route('home')">
        ...
        <div class="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
            <a href="{{ route('user.register') }}" class="px-5 py-2.5 text-sm font-medium text-center text-white rounded-3xl bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gradient-to-r from-primary to-secondary dark:hover:bg-secondary dark:focus:ring-primary">
                Get started
            </a>
