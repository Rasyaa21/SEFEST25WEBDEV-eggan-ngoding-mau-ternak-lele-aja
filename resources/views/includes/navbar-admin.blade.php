...
<aside
  ...
  class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-bactext-white duration-300 ease-linear dark:bg-white lg:static lg:translate-x-0"
  @click.outside="handleOutsideClick"
>
  <div class="flex items-center justify-between gap-2 px-6 pt-12 lg:pt-8">
  ...
  <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
    ...
    >
      <div>
        <h3 class
      <div>
        <h3 class="mb-4 ml-4 text-sm font-medium text-primary">MENU</h3>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-primary duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="{{ route('pantau.kolam') }}"
              @click="selected = (selected === 'PantauKolam' ? '':'PantauKolam')"
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'PantauKolam') && (page === 'PantauKolam') }"
              :class="page === 'PantauKolam' && 'bg-graydark'"
            >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
